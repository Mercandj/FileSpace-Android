...
public class World extends EntityGroup {
    ...
    public class Planet {
        ...
        public Planet(Vector3D position, float vZ, int resourceId) {
    ...
    public void init() {
		...
		*/
        ...
        Object3D sun = new Object3D(context);
        ...
        planets.add(new Planet(new Vector3D(32.0f, 30.0f, 25.0f), -0.020f, R.drawable.color_green));
        planets.add(new Planet(new Vector3D(35.0f, 30.0f, 5.0f), -0.025f, R.drawable.color_blue));
        planets.add(new Planet(new Vector3D(30.0f, 30.0f, 33.0f), -0.029f, R.drawable.color_red));
        planets.add(new Planet(new Vector3D(32.0f, 30.0f, 26.0f), -0.012f, R.drawable.color_white));
        planets.add(new Planet(new Vector3D(34.0f, 30.0f, 28.0f), -0.01f, R.drawable.color_yellow));
        planets.add(new Planet(new Vector3D(33.0f, 30.0f, 0.0f), -0.007f, R.drawable.color_purple));

        for (Planet planet : planets) {
            Object3D earth = new Object3D(context);
        ...
        */
        ...
        Object3D floor = new Object3D(context);
