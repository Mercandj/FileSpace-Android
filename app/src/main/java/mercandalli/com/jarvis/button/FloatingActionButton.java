package mercandalli.com.jarvis.button;
...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        mRipple = attr.getResourceId(R.styleable.FloatingActionButton_fab_ripple, 0);
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(
            ...
            new Drawable[] {
                    getResources().getDrawable(R.drawable.circle_button_ripple_white),//getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.fab_bg_normal : R.drawable.fab_bg_mini),
    ...
    private Drawable createOuterStrokeDrawable(float strokeWidth) {
        ...
        paint.setAlpha(0/*opacityToAlpha(0.02f)*/);
