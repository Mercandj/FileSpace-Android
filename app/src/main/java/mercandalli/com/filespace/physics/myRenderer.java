...
package mercandalli.com.filespace.physics;
...
import mercandalli.com.filespace.physics.implementation.World;
import mercandalli.com.filespace.physics.objects.Camera;
import mercandalli.com.filespace.physics.physics.PhysicsEngine;
...
public class myRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        if((tmp_time = (System.currentTimeMillis()-time))>1000) {
	        ...
	        fps = tmp_fps; tmp_fps = 0; time = System.currentTimeMillis();
        }
    }
