...
import mercandalli.com.filespace.physics.lib.IFunctionEntity;
...
import mercandalli.com.filespace.physics.physics.PhysicsConst;
...
public class myObject3D extends Entity {
	...
	public void translate(final float x, final float y, final float z) {		
		this.position.dX += x; this.position.dY += y; this.position.dZ += z;
