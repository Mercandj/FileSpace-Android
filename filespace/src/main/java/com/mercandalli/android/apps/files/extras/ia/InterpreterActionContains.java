 ...
 */
package com.mercandalli.android.apps.files.extras.ia;

import android.content.Context;

import com.mercandalli.android.apps.files.extras.ia.action.ENUM_Action;
import com.mercandalli.android.apps.files.home.IModelFormListener;
import com.mercandalli.android.apps.files.home.ModelForm;
...
public class InterpreterActionContains extends Interpreter {
    ...
    public InterpreterResult interpret(String input) {
        ...
        if (input.contains("quit") || input.contains("kit l'app"))
            ...
            IaUtils.setAlarmFromString(mContext, input);
