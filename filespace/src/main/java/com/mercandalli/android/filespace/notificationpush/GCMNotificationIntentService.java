...
import com.mercandalli.android.filespace.user.ConversationActivity;
...
public class GCMNotificationIntentService extends IntentService {
    ...
    private void sendNotification(ModelServerMessage serverMessage) {
        ...
        if (serverMessage.isConversationMessage()) {
            ...
            i = manager.getLaunchIntentForPackage("com.mercandalli.android.filespace");
    ...
    private void saveServerMessage(ModelServerMessage serverMessage) {
        if (serverMessage == null)
            return;
        try {
            JSONObject tmp_json = new JSONObject(FileUtils.readStringFile(this.getApplicationContext(), com.mercandalli.android.filespace.main.Config.getFileName()));
            if (tmp_json.has("settings_1")) {
                ...
                FileUtils.writeStringFile(this.getApplicationContext(), com.mercandalli.android.filespace.main.Config.getFileName(), tmp_json.toString());
            }
